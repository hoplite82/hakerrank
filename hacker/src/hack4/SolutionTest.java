...
public class SolutionTest {
	...
	public static Path[][] data() {
		return new Path[][] {
				{ Path.of("testdata/hack4/input4"), Path.of("testdata/hack4/output4") }
	...
	public void testSolution() throws IOException {
		Path pathtoexpected = Path.of("./testdata/hack4/output4");
		Path pathtoinput = Path.of("./testdata/hack4/input4");
